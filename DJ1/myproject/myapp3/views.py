...
def about(request):
    return render(request, "myapp3/about.html")  # пример наследования


def index(request):
    return render(request, "myapp3/index.html")  # пример глобального наследования


class TemplIf(TemplateView):  # TemplateView отдельный базовый класс. Еще один стиль
...
def author_posts(request, author_id):
    ...
    # for i in posts:
    #     print(i.get_summary())    # здесь к методу модели обращаемся с (), в шаблоне без ()
