...
class UserForm(forms.Form):
    ...
    def clean_email(self):
        ...
        if not (email.endswith('vk.team') or email.endswith('corp.mail.ru')):  # окончание почты д/б конкретным
...
class ManyFieldsFormWidget(forms.Form):
    ...
    # Любой стиль к отдельным полям, после class
...
class ImageForm(forms.Form):
    image = forms.ImageField()  # если хотим сохранять файл, используем fileField
